            ...
            <motion.div className='w-full max-w-3xl bg-white rounded-2xl shadow-xl p-10'>
                ...
                <div className='mb-10'>
                    ...
                    <div className='space-y-4'>
                        <input type="text" className='w-full rounded-xl border border-zinc-300 px-4 py-3 text-sm focus:outline-none focux:ring-2 focus:rung-black/80'  placeholder='Business Name' onChange={(e)=>setBusinessName(e.target.value)} value={businessName} />
                        <input type="text" className='w-full rounded-xl border border-zinc-300 px-4 py-3 text-sm focus:outline-none focux:ring-2 focus:rung-black/80'  placeholder='Support Email' onChange={(e)=>setSupportEmail(e.target.value)} value={supportEmail}/>
                    </div> 
                </div>
                <div className='mb-10'>
                    ...
                    <div className='space-y-4'>
                        <textarea className='w-full h-50 rounded-xl border border-zinc-300 px-4 py-3 text-sm focus:outline-none focux:ring-2 focus:rung-black/80'  placeholder={`Example:
