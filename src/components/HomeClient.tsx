    ...
    <div className='min-h-screen bg-linear-to-br from-white to-zinc-50 text-zinc-900 overflow-x-hidden'>
      <motion.div
        ...
        <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
          ...
          {/* Conditional Rendering: Show Avatar if email exists, else show Login Button */}
          {email ? (
            ...
            <AnimatePresence>
              {open && (
                ...
                className='absolute right-0 mt-3 w-44 bg-white rounded-xl shadow-xl border border-zinc-200 overflow-hidden'>
                  ...
                  <button className='block px-4 py-3 text-red-600 hover:bg-zinc-100' onClick={handleLogOut}>Logout</button>
                  {/* Dropdown items go here, e.g., a Logout button */}
          ...
          >
            <div className='rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6'>
              ...
              <div className='space-y-3'> 
                ...
                <div className='bg-zinc-100 rounded-lg px-4 py-2 text-sm'>yes, Cash on delivery is available</div>
              </div>
              <motion.div
                animate={{y:[0,-12,0] }}
                transition={{repeat: Infinity, duration:3}}
                className='ansolute -bottom-6 -right-6 w-14 h-14 rounded-full bg-black text-white flex items-center justify-center shadow-xl'
