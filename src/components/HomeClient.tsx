...
function HomeClient({ email: propEmail }: { email: string }) {
  const [loading, setLoading] = useState(false)

  // Store email in state so UI updates after login
              ...
              <AnimatePresence>
                {open && (
                  ...
                  >
                    ...
                    <button
                      className='w-full text-left px-4 py-3 text-red-600 hover:bg-zinc-100'
        ...
        <div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center'>
          ...
          >
            ...
            <div className='mt-10 flex gap-4'>
              {email ? (
                <button
                  className='px-7 py-3 rounded-xl bg-black text-white font-medium hover:bg-zinc-800 transition'
                  onClick={() => navigate.push("/dashboard")}
                >
                  Go to Dashboard
                </button>
          ...
          <motion.div
            ...
            className='relative'
          >
            <div className="relative rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6">
